...
<h3 id="comments-title">
    <span><?php comments_number( __('No comments', 'yit'), __('1 comment', 'yit'), __('% comments', 'yit') ); ?>
    <img src="<?php echo get_template_directory_uri(); ?>/theme/templates/comments/images/comment-header.png" class="image" ></span>
</h3>
...
$comment_args = array(
    ...
    'title_reply'          => '<span>'.__( 'Leave a Reply', 'yit' ).' <img src="'.get_template_directory_uri().'/theme/templates/comments/images/reply-header.png" class="image" ></span>',
    'title_reply_to'       => '<span>'.__( 'Leave a Reply to %s', 'yit' ).' <img src="'.get_template_directory_uri().'/theme/templates/comments/images/reply-header.png" class="image" ></span>',
