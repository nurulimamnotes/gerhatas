...
// Output styles
	...
	function wrockmetro_themefoot() {
	if (of_get_option('wrockmetro_ftarea') != '') {
            echo '' . of_get_option('wrockmetro_ftarea') . '' . "\n";
        }
	else {echo '&#169; 2013 Theme by: <a href="http://www.insertcart.com/wrock-metro" title="wRock.Org">InsertCart</a>' . "\n";
	}	
	}
