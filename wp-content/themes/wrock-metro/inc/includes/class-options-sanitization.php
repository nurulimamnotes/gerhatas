...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'wrockmetro' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'wrockmetro' ),
		'repeat-y'  => __( 'Repeat Vertically', 'wrockmetro' ),
		'repeat'    => __( 'Repeat All', 'wrockmetro' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'wrockmetro' ),
		'top center'    => __( 'Top Center', 'wrockmetro' ),
		'top right'     => __( 'Top Right', 'wrockmetro' ),
		'center left'   => __( 'Middle Left', 'wrockmetro' ),
		'center center' => __( 'Middle Center', 'wrockmetro' ),
		'center right'  => __( 'Middle Right', 'wrockmetro' ),
		'bottom left'   => __( 'Bottom Left', 'wrockmetro' ),
		'bottom center' => __( 'Bottom Center', 'wrockmetro' ),
		'bottom right'  => __( 'Bottom Right', 'wrockmetro')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'wrockmetro' ),
		'fixed'  => __( 'Fixed in Place', 'wrockmetro')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'wrockmetro' ),
		'italic'      => __( 'Italic', 'wrockmetro' ),
		'bold'        => __( 'Bold', 'wrockmetro' ),
		'bold italic' => __( 'Bold Italic', 'wrockmetro' )
		);
